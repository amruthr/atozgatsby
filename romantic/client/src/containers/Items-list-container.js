...
class ProductsListContainer extends Component {
  ...
  componentDidMount = () => {
    this.props.match.params.gender ==undefined ?
    this.props.match.params.brand== undefined? this.props.fetchDataApi(`/api/productsdata`)
    :
    this.props.fetchDataApi(`/api/brand/${this.props.match.params.brand}`)
    :
    this.props.fetchDataApi(`/api/productsdata/${this.props.match.params.gender}`);    
}


touchme = () =>{
  this.style.display.background="#000";
}
