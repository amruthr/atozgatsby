...
class EditCategory extends Component {
  ...
  this.setState({gender:this.props.infos.gender})
  }

  toggle = () => this.setState({ modalEdit: !this.state.modalEdit });
  toggleHide = () =>this.setState({hide:!this.state.hide})
  toggleGender = () =>this.setState({gender:this.state.gender=="male"?"female":"male"})

  onSubmit = (id, catname, subcats, images, hide, gender) => {
          ...
          <ModalBody>  
            ...
            <InputGroup>
              ...
              <InputGroup>
               ...
               <Button onClick={()=>this.toggleHide()} >{this.state.hide?"hidden": 'visible'}</Button>
              </InputGroup>     
              <InputGroup>
                <InputGroupAddon addonType="prepend">
                  <InputGroupText>Gender:</InputGroupText>
                </InputGroupAddon>
               <Button onClick={()=>this.toggleGender()} >{this.state.gender}</Button>
              </InputGroup>    
              <InputGroup>
                <InputGroupAddon addonType="prepend">
