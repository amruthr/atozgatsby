      ...
      <Table responsive striped hover size="sm">
        ...
        <tbody>
        {
          ...
          <td>{x.customerinfo.firstName + " "+ x.customerinfo.lastName}</td>
              <td>{x.approved===undefined?<Badge color="warning">Pending</Badge>:x.approved==="approved"?<Badge color="warning">Approved</Badge>:x.approved==="delivered"?<Badge color="success">Delivered</Badge>:x.approved==="cancelled"?<Badge color="danger">Cancelled</Badge>:<Badge color="danger" className="fa fa-warning">Error</Badge> }</td>       
            </tr>
            )
          }
        </tbody>
