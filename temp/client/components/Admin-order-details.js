    ...
    return (        
     <div style={{paddingTop: '50px', paddingBottom:'50px', background: "#fff", fontSize:"12px"}}>
      <div className="container">
        ...
        <Row className="my-4">
          <Col md="3">
            <Button className="black-o-btn" onClick={()=>this.pastDay()}>Past Day</Button>
          </Col>
          <Col md="3">
            <Button className="black-o-btn" onClick={()=>this.pastWeek()}>Past Week</Button>
          </Col>
          <Col md="3">
            <Button className="black-o-btn" onClick={()=>this.pastMonth()}>Past Month</Button>
          </Col>
          <Col md="3">
            <Button className="black-o-btn" onClick={()=>this.pastYear()}>Past Year</Button>
          </Col>
