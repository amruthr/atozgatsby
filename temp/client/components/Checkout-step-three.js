  ...
  return (
    <div style={styles.collapsePannel}>
      <ListGroupItem disabled={!step3} >
        ...
        <small className="text-center mx-1 my-3"> Estimated delivery :{(postalCode/1000).toFixed(0) == '575'||(postalCode/1000).toFixed(0) == '574' ? '2 - 4 business days': '4 - 7 business days' }</small>
        </Collapse>
      </ListGroupItem>
    </div>
  )
